...
class ProductItem {
  ...
  render() {
    ...
    prodEl.innerHTML = `
              ...
              `;
    const addToCarButton = prodEl.querySelector('button');
    addToCarButton.addEventListener('click', this.addToCart.bind(this));
    return prodEl;
  }
}
...
class ShoppingCart {
  ...
  render() {
    ...
    // property yang tidak perlu dimasukin dalam constructor
